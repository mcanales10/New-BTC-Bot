            ...
            if (prevSlug && prevSlug !== slug) {
                ...
                try {
                    ...
                    if (this.wsOrderBook) {
                        ...
                        this.wsOrderBook.setTokenPair(newTokenIds.upTokenId, newTokenIds.downTokenId);
